...
const ACCENTS: Record<Exclude<IconAccent, "muted">, { a: string; b: string; shadow: string }> = {
  violet: { a: "var(--violet)", b: "var(--violet-dk)", shadow: "rgba(139, 92, 246, 0.45)" },
  "violet-light": { a: "var(--violet-light)", b: "var(--violet)", shadow: "rgba(192, 132, 252, 0.4)" },
  cyan: { a: "var(--cyan)", b: "var(--cyan-dk)", shadow: "rgba(56, 189, 248, 0.4)" },
  rose: { a: "var(--red)", b: "var(--red-dk)", shadow: "rgba(251, 113, 133, 0.4)" },
};
